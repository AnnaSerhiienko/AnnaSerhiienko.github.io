 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zg;function dv(){if(Zg)return Ot;Zg=1;var n=zn();function o(k){var O="https://react.dev/errors/"+k;if(1<arguments.length){O+="?args[]="+encodeURIComponent(arguments[1]);for(var V=2;V<arguments.length;V++)O+="&args[]="+encodeURIComponent(arguments[V])}return"Minified React error #"+k+"; visit "+O+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(){}var s={d:{f:u,r:function(){throw Error(o(522))},D:u,C:u,L:u,m:u,X:u,S:u,M:u},p:0,findDOMNode:null},y=Symbol.for("react.portal");function b(k,O,V){var W=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:y,key:W==null?null:""+W,children:k,containerInfo:O,implementation:V}}var M=n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function G(k,O){if(k==="font")return"";if(typeof O=="string")return O==="use-credentials"?O:""}return Ot.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Ot.createPortal=function(k,O){var V=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!O||O.nodeType!==1&&O.nodeType!==9&&O.nodeType!==11)throw Error(o(299));return b(k,O,null,V)},Ot.flushSync=function(k){var O=M.T,V=s.p;try{if(M.T=null,s.p=2,k)return k()}finally{M.T=O,s.p=V,s.d.f()}},Ot.preconnect=function(k,O){typeof k=="string"&&(O?(O=O.crossOrigin,O=typeof O=="string"?O==="use-credentials"?O:"":void 0):O=null,s.d.C(k,O))},Ot.prefetchDNS=function(k){typeof k=="string"&&s.d.D(k)},Ot.preinit=function(k,O){if(typeof k=="string"&&O&&typeof O.as=="string"){var V=O.as,W=G(V,O.crossOrigin),le=typeof O.integrity=="string"?O.integrity:void 0,ue=typeof O.fetchPriority=="string"?O.fetchPriority:void 0;V==="style"?s.d.S(k,typeof O.precedence=="string"?O.precedence:void 0,{crossOrigin:W,integrity:le,fetchPriority:ue}):V==="script"&&s.d.X(k,{crossOrigin:W,integrity:le,fetchPriority:ue,nonce:typeof O.nonce=="string"?O.nonce:void 0})}},Ot.preinitModule=function(k,O){if(typeof k=="string")if(typeof O=="object"&&O!==null){if(O.as==null||O.as==="script"){var V=G(O.as,O.crossOrigin);s.d.M(k,{crossOrigin:V,integrity:typeof O.integrity=="string"?O.integrity:void 0,nonce:typeof O.nonce=="string"?O.nonce:void 0})}}else O==null&&s.d.M(k)},Ot.preload=function(k,O){if(typeof k=="string"&&typeof O=="object"&&O!==null&&typeof O.as=="string"){var V=O.as,W=G(V,O.crossOrigin);s.d.L(k,V,{crossOrigin:W,integrity:typeof O.integrity=="string"?O.integrity:void 0,nonce:typeof O.nonce=="string"?O.nonce:void 0,type:typeof O.type=="string"?O.type:void 0,fetchPriority:typeof O.fetchPriority=="string"?O.fetchPriority:void 0,referrerPolicy:typeof O.referrerPolicy=="string"?O.referrerPolicy:void 0,imageSrcSet:typeof O.imageSrcSet=="string"?O.imageSrcSet:void 0,imageSizes:typeof O.imageSizes=="string"?O.imageSizes:void 0,media:typeof O.media=="string"?O.media:void 0})}},Ot.preloadModule=function(k,O){if(typeof k=="string")if(O){var V=G(O.as,O.crossOrigin);s.d.m(k,{as:typeof O.as=="string"&&O.as!=="script"?O.as:void 0,crossOrigin:V,integrity:typeof O.integrity=="string"?O.integrity:void 0})}else s.d.m(k)},Ot.requestFormReset=function(k){s.d.r(k)},Ot.unstable_batchedUpdates=function(k,O){return k(O)},Ot.useFormState=function(k,O,V){return M.H.useFormState(k,O,V)},Ot.useFormStatus=function(){return M.H.useHostTransitionStatus()},Ot.version="19.2.3",Ot}var Kg;function pv(){if(Kg)return nu.exports;Kg=1;function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(o){console.error(o)}}return n(),nu.exports=dv(),nu.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zb=_e.forwardRef(({color:n="currentColor",size:o=24,strokeWidth:u=2,absoluteStrokeWidth:s,className:y="",children:b,iconNode:M,...G},k)=>_e.createElement("svg",{ref:k,...wb,width:o,height:o,stroke:n,strokeWidth:s?Number(u)*24/Number(o):u,className:bm("lucide",y),...!b&&!$b(G)&&{"aria-hidden":"true"},...G},[...M.map(([O,V])=>_e.createElement(O,V)),...Array.isArray(b)?b:[b]]));/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ab=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],Uu=gt("arrow-right",Ab);/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ob=[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]],_b=gt("arrow-up-right",Ob);/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,w1=m.button`
  ...
  font-weight: ${({theme:n})=>n.typography.weights.bold};
  cursor: pointer;
`,z1=({onNavigate:n})=>{const{t:o}=_t(),[u,s]=_e.useState(!1),[y,b]=_e.useState(!1);_e.useEffect(()=>{const V=()=>{s(window.scrollY>20)};return window.addEventListener("scroll",V),()=>window.removeEventListener("scroll",V)},[]);const M=V=>{if(n){n(V),b(!1);return}const W=document.getElementById(V);W&&(W.scrollIntoView({behavior:"smooth"}),b(!1))},G=()=>{window.location.href="mailto:hi.anna.design@gmail.com"},k=()=>{alert(o.nav.cvAlert)},O=[{label:o.nav.work,id:rn.WORK},{label:o.nav.about,id:rn.ABOUT}];return d.jsxs(d.Fragment,{children:[d.jsx(c1,{$scrolled:u,children:d.jsxs(u1,{children:[d.jsxs($m,{onClick:()=>M(rn.HERO),children:[d.jsx(f1,{children:"A."}),d.jsx(d1,{children:o.nav.brandText})]}),d.jsxs(p1,{children:[O.map(V=>d.jsx(g1,{onClick:()=>M(V.id),children:V.label},V.id)),d.jsxs(h1,{children:[d.jsxs(m1,{onClick:k,children:[d.jsx(dh,{size:16}),o.nav.cv]}),d.jsx(y1,{onClick:G,children:o.nav.hireMe})]})]}),d.jsx(v1,{onClick:()=>b(!y),children:y?d.jsx(Bu,{size:24}):d.jsx(Sm,{size:24})})]})}),d.jsxs(b1,{$open:y,children:[O.map(V=>d.jsx(S1,{onClick:()=>M(V.id),children:V.label},V.id)),d.jsxs(x1,{children:[d.jsxs($1,{onClick:k,children:[d.jsx(dh,{size:24}),o.nav.cv]}),d.jsx(w1,{onClick:G,children:o.nav.hireMe})]})]})]})},T1={light:"light",regular:"regular",medium:"medium",bold:"bold"},j1={xs:"xs",sm:"sm",md:"md",lg:"lg",xl:"xl"},E1=m.span`
...
`,k1=m.div`
  ...
  margin: 0 auto;
  animation: ${O1} 0.8s cubic-bezier(0, 0, 0.2, 1) forwards;
`,_u=m.div`
  position: absolute;
...
`,B1=()=>{const{t:n}=_t();return d.jsx(_1,{id:rn.HERO,children:d.jsxs(k1,{children:[d.jsx(_u,{style:{left:_.sizing.heroFloatLeftOffset,top:0},children:d.jsx(Nb,{color:"#7c3aed",size:32})}),d.jsx(ph,{style:{right:_.sizing.heroFloatRightOffset,top:_.sizing.heroFloatRightTop},children:d.jsx(Ib,{color:"#3b82f6",size:32})}),d.jsx(ph,{style:{left:_.sizing.heroFloatLeftAlt,bottom:0},children:d.jsx(Xb,{color:"#ec4899",size:32})}),d.jsx(_u,{style:{right:0,bottom:_.sizing.heroFloatRightBottom},children:d.jsx(Yb,{color:"#10b981",size:32})}),d.jsxs(C1,{children:[d.jsx(M1,{}),d.jsx(D1,{children:n.hero.available})]}),d.jsxs(H1,{children:[n.hero.heading1," ",d.jsx("br",{}),d.jsx(R1,{children:n.hero.heading2})]}),d.jsx(L1,{element:"p",message:o=>o.hero.lead}),d.jsx(N1,{children:d.jsxs(wm,{onClick:()=>{var o;return(o=document.getElementById(rn.WORK))==null?void 0:o.scrollIntoView({behavior:"smooth"})},children:[n.hero.viewWork,d.jsx(U1,{size:18})]})})]})})},se="/assets",G1=`${se}/images/brand/app-icons-splash-screens/full-composition.png`,q1=`${se}/images/brand/Namelaka icons and illustration/Full_Composition_Namelaka.png`,Y1=`${se}/images/brand/Mindzy – Brain Training/UI/Full_Composition_Mindzy – Brain Training.png`,V1=`${se}/images/brand/Full_Composition_Marketing_video.png`,X1=`${se}/images/brand/Elemental Quest game/Full_Composition_Elemental Quest game map.png`,Q1=`${se}/images/brand/Combat Planes/Full_Composition_logo_Combat Planes.png`,Z1=`${se}/images/brand/Fatty Fish/Character.png`,K1=`${se}/images/brand/Lending Harry Potter vs Darth_Vader/Harry_Potter_part_1.png`,P1=[`${se}/images/brand/App Store Screenshots/1 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/2 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/3 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/4 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/5 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/6 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/7 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/8 Cat Wars.jpg`,`${se}/images/brand/App Store Screenshots/1 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/2 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/3 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/4 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/5 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/6 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/7 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/8 Elemental Craft.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 1.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 2.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 3.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 4.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 5.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 6.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 7.jpg`,`${se}/images/brand/App Store Screenshots/Cloud Noise 8.jpg`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 1.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 2.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 3.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 4.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 5.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 6.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 7.png`,`${se}/images/brand/App Store Screenshots/Monstrous Evorise 8.png`,`${se}/images/brand/App Store Screenshots/Scriptor 1.jpg`,`${se}/images/brand/App Store Screenshots/Scriptor 2.jpg`,`${se}/images/brand/App Store Screenshots/Scriptor 3.jpg`,`${se}/images/brand/App Store Screenshots/Scriptor 4.jpg`,`${se}/images/brand/App Store Screenshots/Scriptor 5.jpg`,`${se}/images/brand/App Store Screenshots/Scriptor 6.jpg`,`${se}/images/brand/App Store Screenshots/Selara 1.jpg`,`${se}/images/brand/App Store Screenshots/Selara 2.jpg`,`${se}/images/brand/App Store Screenshots/Selara 3.jpg`,`${se}/images/brand/App Store Screenshots/Selara 4.jpg`,`${se}/images/brand/App Store Screenshots/Selara 5.jpg`,`${se}/images/brand/App Store Screenshots/Selara 6.jpg`,`${se}/images/brand/App Store Screenshots/Selara 7.jpg`,`${se}/images/brand/App Store Screenshots/Sky Hero 1.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 2.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 3.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 4.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 5.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 6.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 7.png`,`${se}/images/brand/App Store Screenshots/Sky Hero 8.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 1.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 2.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 3.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 4.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 5.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 6.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 7.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 8.png`,`${se}/images/brand/App Store Screenshots/Star Cleaning 9.png`],Eo="Anna Serhiienko",W1="Graphic Designer",J1="My name is Anna Serhiienko. I have been working as a graphic designer for 5 years. I specialize in creating cohesive visual languages across various media. Whether it's crafting a unique brand identity, designing intuitive user interfaces, or building immersive game assets, I bring creativity and precision to every project.",I1=["Brand design","UI/UX design","Marketing and advertising","Games","Landing"],zm=["Graphic Design","UI/UX Design","Game Art & Assets","Digital Illustration","Brand Identity","Adobe Creative Suite","Figma","Marketing Creatives"],Ao=[{id:20,title:"Namelaka Icons & Illustration",category:"UI/UX design",mediaUrl:q1,mediaType:"image",description:"Iconography and illustration set for Namelaka, covering UI states, empty screens, and branded visuals.",link:"#namelaka",technologies:["Illustration","Icon Design","UI Assets"]},{id:15,title:"App Icons & Splash Screens",category:"Brand design",mediaUrl:G1,mediaType:"image",description:"A collection of vibrant app icons and splash screens designed for mobile applications, featuring playful characters and bold visual identities.",link:"#app-icons",technologies:["Illustrator","Icon Design","Mobile Branding"]},{id:19,title:"RevBack Logo Design",category:"Brand design",mediaUrl:"https://cdn.dribbble.com/userupload/36126269/file/original-f90f3932c3f7d4e6048c28f799c4cbba.gif",mediaType:"image",description:"Logo design exploration for the RevBack mobile app with a bold, modern identity.",link:"https://dribbble.com/shots/17802180-Logo-design-for-RevBack-mobile-app",technologies:["Logo Design","Brand Identity","Illustrator"]},{id:21,title:"Mindzy – Brain Training",category:"UI/UX design",mediaUrl:Y1,mediaType:"image",description:"Interface suite for Mindzy, showcasing a range of brain-training games and playful UI states.",link:"#mindzy",technologies:["UI/UX","Game UI","Visual Design"]},{id:17,title:"App Store Screenshots",category:"Marketing and advertising",mediaUrl:`${se}/images/brand/App Store Screenshots/Full_Composition_App Store Screenshots.png`,mediaType:"image",gallery:P1,description:"A curated set of App Store-ready screenshot compositions showcasing multiple game worlds, UI moments, and promotional layouts.",link:"#app-store-screenshots",technologies:["App Store","Marketing","Visual Design"]},{id:22,title:"Marketing Videos",category:"Marketing and advertising",mediaUrl:V1,mediaType:"image",description:"A collection of promotional videos and motion graphics for mobile app marketing campaigns.",link:"#marketing-video",technologies:["Motion Design","After Effects","Marketing"]},{id:23,title:"Elemental Quest",category:"Games",mediaUrl:X1,mediaType:"image",description:"Game map design and visual assets for an adventure puzzle game featuring magical elements.",link:"#elemental-quest",technologies:["Game Art","Illustration","Visual Design"]},{id:24,title:"Combat Planes",category:"Games",mediaUrl:Q1,mediaType:"image",description:"Character design, plane skins, and game maps for an aerial combat mobile game.",link:"#combat-planes",technologies:["Game Art","Character Design","Visual Design"]},{id:25,title:"Fatty Fish",category:"Games",mediaUrl:Z1,mediaType:"image",description:"Character design, game objects, and visual assets for a fun aquatic mobile game.",link:"#fatty-fish",technologies:["Game Art","Character Design","Visual Design"]},{id:26,title:"Harry Potter vs Darth Vader",category:"Landing",mediaUrl:K1,mediaType:"image",description:"A cinematic landing page for a fantasy crossover game pitting Harry Potter against Darth Vader.",link:"#landing-hp-vs-vader",technologies:["Web Design","Landing Page","Visual Design"]},{id:28,title:"Character Animation Loading",category:"Games",mediaUrl:`${se}/video/Character animation loading.mp4`,mediaType:"video",description:"Short animation for character loading screen, optimized for real-time use in games.",link:"#character-animation-loading",technologies:["Unity","Animation","Game Art"]},{id:27,title:"Animation Character Unity",category:"Games",mediaUrl:`${se}/video/Animation Character Unity.mp4`,mediaType:"video",description:"Animated character created for Unity game engine. Includes rigging, animation cycles, and export for real-time use.",link:"#animation-character-unity",technologies:["Unity","Animation","Character Design"]}],F1=[{name:"LinkedIn",url:"https://www.linkedin.com/in/anna-serhiienko-1459a6187/",icon:"Linkedin"},{name:"Dribbble",url:"https://dribbble.com/ArtistAnn",icon:"Dribbble"}];`${Eo}${W1}${J1}${zm.join(", ")}${Ao.map(n=>`- ${n.title} (${n.category}): ${n.description}`).join(`
`)}`;const Tm=Tn`
  0% { opacity: 0; transform: translateY(${_.motion.revealOffset}); }
  100% { opacity: 1; transform: translateY(0); }
`,eS=Tn`
...
`,LS=()=>{const{t:n}=_t(),[o,u]=_e.useState("All"),[s,y]=_e.useState(null),b=k=>k.includes(" ")?encodeURI(k):k;_e.useEffect(()=>{if(!s)return;const k=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=k}},[s]);const M=["All",...I1],G=_e.useMemo(()=>o==="All"?Ao:Ao.filter(k=>k.category===o),[o]);return d.jsxs(tS,{id:rn.WORK,children:[d.jsxs(nS,{children:[d.jsxs(aS,{children:[d.jsxs(iS,{children:[d.jsx(lS,{children:n.work.title}),d.jsx(rS,{children:n.work.subtitle})]}),d.jsx(oS,{children:M.map(k=>d.jsx(sS,{$active:o===k,onClick:()=>u(k),children:k==="All"?n.work.all:ou(k,n)},k))})]}),d.jsx(cS,{children:G.map((k,O)=>{const V=n.projects[k.id],W=(V==null?void 0:V.title)??k.title;return d.jsx(Zl,{style:{animationDelay:`${O*.1}s`},onClick:()=>y(k),children:d.jsxs(uS,{children:[k.mediaType==="video"?d.jsx(dS,{src:b(k.mediaUrl),muted:!0,loop:!0,playsInline:!0,autoPlay:!0}):d.jsx(fS,{src:b(k.mediaUrl),alt:W}),d.jsxs(pS,{children:[d.jsx(gS,{children:ou(k.category,n)}),d.jsx(hS,{children:W}),d.jsx(mS,{children:d.jsx(_b,{size:24})})]})]})},k.id)})}),G.length===0&&d.jsxs(yS,{children:[d.jsx(Gb,{color:"#e2e8f0",size:48}),d.jsx(vS,{children:n.work.emptyState})]})]}),s&&(()=>{const k=n.projects[s.id],O=(k==null?void 0:k.title)??s.title,V=(k==null?void 0:k.description)??s.description,W=(k==null?void 0:k.technologies)??s.technologies;return d.jsxs(bS,{children:[d.jsx(SS,{onClick:()=>y(null)}),d.jsxs(xS,{children:[d.jsx($S,{onClick:()=>y(null),"aria-label":n.work.close,children:d.jsx(Bu,{size:24})}),d.jsx(wS,{children:s.mediaType==="video"?d.jsx(TS,{src:b(s.mediaUrl),autoPlay:!0,muted:!0,loop:!0,controls:!0}):d.jsx(zS,{src:b(s.mediaUrl),alt:O})}),d.jsxs(jS,{children:[d.jsxs(ES,{children:[d.jsx(n1,{size:14}),d.jsx(AS,{children:ou(s.category,n)})]}),d.jsx(OS,{children:O}),d.jsx(_S,{children:V}),d.jsxs(kS,{children:[d.jsx(CS,{children:n.work.technologies}),d.jsx(MS,{children:W.map((le,ue)=>d.jsx(DS,{children:le},ue))})]}),d.jsx(HS,{children:d.jsxs(RS,{href:s.link,children:[n.work.viewProject,d.jsx(Rb,{size:18})]})})]})]})]})})()]})},NS=Tn`
  0%, 100% { transform: translateY(0); }
  50% { transform: translateY(${_.motion.floatOffset}); }
`,US=m.section`
  position: relative;
...
`,Mw=m.img`
  ...
  height: auto;
  display: block;
`,Nh=n=>n.includes(" ")?encodeURI(n):n,Dw=({onBack:n})=>{const{t:o}=_t();return d.jsxs(bw,{children:[d.jsx(Sw,{children:d.jsxs(xw,{children:[d.jsxs($w,{onClick:n,children:[d.jsx(mn,{size:18}),o.combatPlanes.backToPortfolio]}),d.jsx(ww,{children:o.combatPlanes.headerTag})]})}),d.jsxs(zw,{children:[d.jsx(Tw,{children:o.combatPlanes.eyebrow}),d.jsx(jw,{children:o.combatPlanes.title}),d.jsx(Ew,{children:o.combatPlanes.lead})]}),d.jsxs(Aw,{children:[d.jsx(Ow,{children:d.jsx(_w,{src:Nh(yw),alt:o.combatPlanes.logoAlt})}),d.jsx(kw,{children:vw.map((u,s)=>d.jsx(Cw,{children:d.jsx(Mw,{src:Nh(u),alt:`${o.combatPlanes.galleryAlt} ${s+1}`})},s))})]})]})},Lm="/assets",Ql=`${Lm}/images/brand/Fatty Fish`,Hw=`${Ql}/Logo Fatty Fish.png`,Rw=`${Lm}/video/Fatty Fish/Fatty Fish video.mp4`,Lw=[`${Ql}/Character.png`,`${Ql}/Objects.png`],Nw=[`${Ql}/IMG_1.png`,`${Ql}/IMG_2.png`],Uw=m.section`
  min-height: ${_.layout.fullViewportHeight};
  background: #4F22D1;
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,Bw=m.header`
