 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zg;function dv(){if(Zg)return _t;Zg=1;var n=zn();function o(k){var _="https://react.dev/errors/"+k;if(1<arguments.length){_+="?args[]="+encodeURIComponent(arguments[1]);for(var V=2;V<arguments.length;V++)_+="&args[]="+encodeURIComponent(arguments[V])}return"Minified React error #"+k+"; visit "+_+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(){}var s={d:{f:u,r:function(){throw Error(o(522))},D:u,C:u,L:u,m:u,X:u,S:u,M:u},p:0,findDOMNode:null},y=Symbol.for("react.portal");function b(k,_,V){var W=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:y,key:W==null?null:""+W,children:k,containerInfo:_,implementation:V}}var M=n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function G(k,_){if(k==="font")return"";if(typeof _=="string")return _==="use-credentials"?_:""}return _t.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,_t.createPortal=function(k,_){var V=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!_||_.nodeType!==1&&_.nodeType!==9&&_.nodeType!==11)throw Error(o(299));return b(k,_,null,V)},_t.flushSync=function(k){var _=M.T,V=s.p;try{if(M.T=null,s.p=2,k)return k()}finally{M.T=_,s.p=V,s.d.f()}},_t.preconnect=function(k,_){typeof k=="string"&&(_?(_=_.crossOrigin,_=typeof _=="string"?_==="use-credentials"?_:"":void 0):_=null,s.d.C(k,_))},_t.prefetchDNS=function(k){typeof k=="string"&&s.d.D(k)},_t.preinit=function(k,_){if(typeof k=="string"&&_&&typeof _.as=="string"){var V=_.as,W=G(V,_.crossOrigin),le=typeof _.integrity=="string"?_.integrity:void 0,ue=typeof _.fetchPriority=="string"?_.fetchPriority:void 0;V==="style"?s.d.S(k,typeof _.precedence=="string"?_.precedence:void 0,{crossOrigin:W,integrity:le,fetchPriority:ue}):V==="script"&&s.d.X(k,{crossOrigin:W,integrity:le,fetchPriority:ue,nonce:typeof _.nonce=="string"?_.nonce:void 0})}},_t.preinitModule=function(k,_){if(typeof k=="string")if(typeof _=="object"&&_!==null){if(_.as==null||_.as==="script"){var V=G(_.as,_.crossOrigin);s.d.M(k,{crossOrigin:V,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0})}}else _==null&&s.d.M(k)},_t.preload=function(k,_){if(typeof k=="string"&&typeof _=="object"&&_!==null&&typeof _.as=="string"){var V=_.as,W=G(V,_.crossOrigin);s.d.L(k,V,{crossOrigin:W,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0,type:typeof _.type=="string"?_.type:void 0,fetchPriority:typeof _.fetchPriority=="string"?_.fetchPriority:void 0,referrerPolicy:typeof _.referrerPolicy=="string"?_.referrerPolicy:void 0,imageSrcSet:typeof _.imageSrcSet=="string"?_.imageSrcSet:void 0,imageSizes:typeof _.imageSizes=="string"?_.imageSizes:void 0,media:typeof _.media=="string"?_.media:void 0})}},_t.preloadModule=function(k,_){if(typeof k=="string")if(_){var V=G(_.as,_.crossOrigin);s.d.m(k,{as:typeof _.as=="string"&&_.as!=="script"?_.as:void 0,crossOrigin:V,integrity:typeof _.integrity=="string"?_.integrity:void 0})}else s.d.m(k)},_t.requestFormReset=function(k){s.d.r(k)},_t.unstable_batchedUpdates=function(k,_){return k(_)},_t.useFormState=function(k,_,V){return M.H.useFormState(k,_,V)},_t.useFormStatus=function(){return M.H.useHostTransitionStatus()},_t.version="19.2.3",_t}var Kg;function pv(){if(Kg)return nu.exports;Kg=1;function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(o){console.error(o)}}return n(),nu.exports=dv(),nu.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zb=Ae.forwardRef(({color:n="currentColor",size:o=24,strokeWidth:u=2,absoluteStrokeWidth:s,className:y="",children:b,iconNode:M,...G},k)=>Ae.createElement("svg",{ref:k,...wb,width:o,height:o,stroke:n,strokeWidth:s?Number(u)*24/Number(o):u,className:bm("lucide",y),...!b&&!$b(G)&&{"aria-hidden":"true"},...G},[...M.map(([_,V])=>Ae.createElement(_,V)),...Array.isArray(b)?b:[b]]));/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gt=(n,o)=>{const u=Ae.forwardRef(({className:s,...y},b)=>Ae.createElement(zb,{ref:b,iconNode:o,className:bm(`lucide-${Sb(fh(n))}`,`lucide-${n}`,s),...y}));return u.displayName=fh(n),u};/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _b=[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]],Ab=gt("arrow-up-right",_b);/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,w1=m.button`
  ...
  font-weight: ${({theme:n})=>n.typography.weights.bold};
  cursor: pointer;
`,z1=({onNavigate:n})=>{const{t:o}=At(),[u,s]=Ae.useState(!1),[y,b]=Ae.useState(!1);Ae.useEffect(()=>{const V=()=>{s(window.scrollY>20)};return window.addEventListener("scroll",V),()=>window.removeEventListener("scroll",V)},[]);const M=V=>{if(n){n(V),b(!1);return}const W=document.getElementById(V);W&&(W.scrollIntoView({behavior:"smooth"}),b(!1))},G=()=>{window.location.href="mailto:hi.anna.design@gmail.com"},k=()=>{alert(o.nav.cvAlert)},_=[{label:o.nav.work,id:rn.WORK},{label:o.nav.about,id:rn.ABOUT}];return d.jsxs(d.Fragment,{children:[d.jsx(c1,{$scrolled:u,children:d.jsxs(u1,{children:[d.jsxs($m,{onClick:()=>M(rn.HERO),children:[d.jsx(f1,{children:"A."}),d.jsx(d1,{children:o.nav.brandText})]}),d.jsxs(p1,{children:[_.map(V=>d.jsx(g1,{onClick:()=>M(V.id),children:V.label},V.id)),d.jsxs(h1,{children:[d.jsxs(m1,{onClick:k,children:[d.jsx(dh,{size:16}),o.nav.cv]}),d.jsx(y1,{onClick:G,children:o.nav.hireMe})]})]}),d.jsx(v1,{onClick:()=>b(!y),children:y?d.jsx(Bu,{size:24}):d.jsx(Sm,{size:24})})]})}),d.jsxs(b1,{$open:y,children:[_.map(V=>d.jsx(S1,{onClick:()=>M(V.id),children:V.label},V.id)),d.jsxs(x1,{children:[d.jsxs($1,{onClick:k,children:[d.jsx(dh,{size:24}),o.nav.cv]}),d.jsx(w1,{onClick:G,children:o.nav.hireMe})]})]})]})},T1={light:"light",regular:"regular",medium:"medium",bold:"bold"},j1={xs:"xs",sm:"sm",md:"md",lg:"lg",xl:"xl"},E1=m.span`
...
`,k1=m.div`
  position: relative;
  z-index: 1;
  max-width: ${A.layout.heroContentMaxWidth};
  margin: 0 auto;
  animation: ${_1} 0.8s cubic-bezier(0, 0, 0.2, 1) forwards;
`,Au=m.div`
  position: absolute;
...
`,C1=m.div`
  ...
  background: ${A.effects.glassWhite50};
  backdrop-filter: blur(${A.effects.blurSoft});
  border: ${A.sizing.hairline} solid ${({theme:n})=>n.colors.slate[200]};
  border-radius: ${({theme:n})=>n.radii.full};
...
`,L1=m(Gu)`
  ...
  max-width: ${A.layout.heroLeadMaxWidth};
  color: ${({theme:n})=>n.colors.slate[500]};
  font-size: ${({theme:n})=>n.typography.sizes.lg};
...
`,wm=m.button`
  ...
  &:hover {
    background: ${({theme:n})=>n.colors.brand.purple};
    transform: translateY(${A.motion.hoverLiftSm});
...
`,tS=m.section`
  ...
  background: ${A.effects.sectionWash};
`,nS=m.div`
...
`,iS=m.div`
  max-width: ${A.layout.workHeadingMaxWidth};
`,lS=m.h2`
...
`,sS=m.button`
  ...
  border: ${A.sizing.hairline} solid ${({theme:n,$active:o})=>o?"transparent":n.colors.slate[100]};
...
`,uS=m.div`
  ...
  ${Zl}:hover & {
    transform: translateY(${A.motion.hoverLiftLg});
    box-shadow: ${({theme:n})=>n.shadows.lg};
  }
`,fS=m.img`
  width: 100%;
...
`,pS=m.div`
  ...
  background: ${A.effects.cardOverlayGradient};
  opacity: 1;
  transition: opacity 0.5s ease;
`,gS=m.span`
  color: ${A.effects.overlayWhite60};
  font-size: ${({theme:n})=>n.typography.sizes.xs};
  font-weight: ${({theme:n})=>n.typography.weights.bold};
  text-transform: uppercase;
  letter-spacing: ${({theme:n})=>n.typography.letterSpacing.wide};
...
`,yS=m.div`
  ...
  background: ${({theme:n})=>n.colors.white};
  border-radius: ${({theme:n})=>n.radii["4xl"]};
  border: ${A.sizing.dashedBorderWidth} dashed ${({theme:n})=>n.colors.slate[100]};
`,vS=m.p`
  margin: 0;
  color: ${({theme:n})=>n.colors.slate[400]};
  font-family: ${({theme:n})=>n.typography.fonts.serif};
...
`,SS=m.div`
  position: absolute;
  inset: 0;
  background: ${A.effects.overlayDark95};
  backdrop-filter: blur(${A.effects.blurStrong});
`,xS=m.div`
  position: relative;
  width: 100%;
  max-width: ${A.layout.workModalMaxWidth};
  background: ${({theme:n})=>n.colors.white};
  border-radius: ${({theme:n})=>n.radii["4xl"]};
  overflow: hidden;
  ...
  display: flex;
  flex-direction: column;
  max-height: ${A.layout.workModalMaxHeight};
...
`,$S=m.button`
  ...
  z-index: ${A.zIndex.closeButton};
  width: ${({theme:n})=>n.spacing[9]};
  height: ${({theme:n})=>n.spacing[9]};
  border-radius: ${({theme:n})=>n.radii.full};
  border: none;
  background: ${A.effects.glassWhite10};
  color: ${({theme:n})=>n.colors.slate[900]};
  cursor: pointer;
  backdrop-filter: blur(${A.effects.blurGlass});
  transition: background 0.2s ease;

  &:hover {
    background: ${A.effects.glassWhite20};
  }
`,wS=m.div`
  width: 100%;
  background: ${({theme:n})=>n.colors.slate[100]};
  overflow: hidden;
  height: ${A.layout.workModalMediaHeight};
...
`;m.div`
  ...
  &::-webkit-scrollbar {
    height: ${A.sizing.scrollbarWidth};
  }
...
`;m.div`
  ...
  box-shadow: ${({theme:n})=>n.shadows.sm};
  border: ${A.sizing.hairline} solid ${({theme:n})=>n.colors.slate[100]};
`;m.img`
  width: 100%;
  height: 100%;
  object-fit: contain;
...
`,HS=m.div`
  margin-top: auto;
  padding-top: ${({theme:n})=>n.spacing[8]};
  border-top: ${A.sizing.hairline} solid ${({theme:n})=>n.colors.slate[100]};
`,RS=m.a`
  display: inline-flex;
  align-items: center;
  gap: ${({theme:n})=>n.spacing[3]};
...
`,LS=()=>{const{t:n}=At(),[o,u]=Ae.useState("All"),[s,y]=Ae.useState(null),b=k=>k.includes(" ")?encodeURI(k):k;Ae.useEffect(()=>{if(!s)return;const k=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=k}},[s]);const M=["All",...I1],G=Ae.useMemo(()=>o==="All"?Oo:Oo.filter(k=>k.category===o),[o]);return d.jsxs(tS,{id:rn.WORK,children:[d.jsxs(nS,{children:[d.jsxs(aS,{children:[d.jsxs(iS,{children:[d.jsx(lS,{children:n.work.title}),d.jsx(rS,{children:n.work.subtitle})]}),d.jsx(oS,{children:M.map(k=>d.jsx(sS,{$active:o===k,onClick:()=>u(k),children:k==="All"?n.work.all:ou(k,n)},k))})]}),d.jsx(cS,{children:G.map((k,_)=>{const V=n.projects[k.id],W=(V==null?void 0:V.title)??k.title;return d.jsx(Zl,{style:{animationDelay:`${_*.1}s`},onClick:()=>y(k),children:d.jsxs(uS,{children:[k.mediaType==="video"?d.jsx(dS,{src:b(k.mediaUrl),muted:!0,loop:!0,playsInline:!0,autoPlay:!0}):d.jsx(fS,{src:b(k.mediaUrl),alt:W}),d.jsxs(pS,{children:[d.jsx(gS,{children:ou(k.category,n)}),d.jsx(hS,{children:W}),d.jsx(mS,{children:d.jsx(Ab,{size:24})})]})]})},k.id)})}),G.length===0&&d.jsxs(yS,{children:[d.jsx(Gb,{color:"#e2e8f0",size:48}),d.jsx(vS,{children:n.work.emptyState})]})]}),s&&(()=>{const k=n.projects[s.id],_=(k==null?void 0:k.title)??s.title,V=(k==null?void 0:k.description)??s.description,W=(k==null?void 0:k.technologies)??s.technologies;return d.jsxs(bS,{children:[d.jsx(SS,{onClick:()=>y(null)}),d.jsxs(xS,{children:[d.jsx($S,{onClick:()=>y(null),"aria-label":n.work.close,children:d.jsx(Bu,{size:24})}),d.jsx(wS,{children:s.mediaType==="video"?d.jsx(TS,{src:b(s.mediaUrl),autoPlay:!0,muted:!0,loop:!0,controls:!0}):d.jsx(zS,{src:b(s.mediaUrl),alt:_})}),d.jsxs(jS,{children:[d.jsxs(ES,{children:[d.jsx(n1,{size:14}),d.jsx(OS,{children:ou(s.category,n)})]}),d.jsx(_S,{children:_}),d.jsx(AS,{children:V}),d.jsxs(kS,{children:[d.jsx(CS,{children:n.work.technologies}),d.jsx(MS,{children:W.map((le,ue)=>d.jsx(DS,{children:le},ue))})]}),d.jsx(HS,{children:d.jsxs(RS,{href:s.link,children:[n.work.viewProject,d.jsx(Rb,{size:18})]})})]})]})]})})()]})},NS=Tn`
  0%, 100% { transform: translateY(0); }
  50% { transform: translateY(${A.motion.floatOffset}); }
`,US=m.section`
  position: relative;
...
`,BS=m.div`
  ...
  right: ${A.layout.aboutWatermarkOffsetX};
  font-size: ${A.layout.aboutWatermarkFontSize};
  font-family: ${({theme:n})=>n.typography.fonts.serif};
  font-style: italic;
...
`,QS=m.div`
  position: absolute;
  inset: 0;
  background: ${A.effects.aboutOverlayGradient};
  opacity: 0;
...
`,ZS=m.div`
  ...
  max-width: ${A.layout.aboutExperienceMaxWidth};
...
`,cx=()=>{const{t:n}=At();return d.jsxs(US,{id:rn.ABOUT,children:[d.jsx(BS,{children:n.about.watermark}),d.jsx(GS,{children:d.jsxs(qS,{children:[d.jsxs(YS,{children:[d.jsxs(VS,{children:[d.jsx(XS,{src:"/assets/images/profile/me.png",alt:n.about.portraitAlt}),d.jsx(QS,{"data-overlay":!0})]}),d.jsxs(ZS,{children:[d.jsxs(KS,{children:[d.jsx(e1,{color:"#6366f1",fill:"#6366f1",size:16}),d.jsx(PS,{children:n.about.experience})]}),d.jsxs(WS,{children:["5+ ",d.jsx(JS,{children:n.about.years})]}),d.jsx(IS,{element:"p",message:u=>u.about.experienceText})]})]}),d.jsxs(FS,{children:[d.jsxs(ex,{children:[n.about.heading1," ",d.jsx(tx,{children:n.about.emphasis})," ",d.jsx("br",{})," ",n.about.heading2]}),d.jsx(nx,{element:"p",message:u=>u.about.bio}),d.jsx(ax,{children:d.jsxs("div",{children:[d.jsxs(ix,{children:[d.jsx(lx,{}),n.about.proficiencies]}),d.jsx(rx,{children:zm.map((u,s)=>d.jsx(ox,{children:d.jsxs(sx,{children:[d.jsx(jm,{children:d.jsx(Em,{size:12})}),d.jsx(Om,{children:s1(u,n)})]})},s))})]})})]})]})})]})},ux=m.footer`
  background: ${({theme:n})=>n.colors.white};
  color: ${({theme:n})=>n.colors.slate[900]};
  padding: ${({theme:n})=>n.spacing[12]} ${({theme:n})=>n.spacing[6]};
  border-top: ${A.sizing.hairline} solid ${({theme:n})=>n.colors.slate[100]};
...
`,Wx=m.header`
  position: sticky;
  top: 0;
  z-index: ${A.zIndex.stickyHeader};
  background: ${A.effects.glassWhite70};
  backdrop-filter: blur(${A.effects.blurStrong});
  border-bottom: ${A.sizing.hairline} solid ${A.effects.overlayWhite40};
`,Jx=m.div`
  max-width: ${({theme:n})=>n.layout.container};
  margin: 0 auto;
...
`,a2=m.p`
  max-width: ${A.layout.appIconsHeroLeadMaxWidth};
  font-size: ${({theme:n})=>n.typography.sizes.lg};
  line-height: ${({theme:n})=>n.typography.lineHeights.relaxed};
  color: ${({theme:n})=>n.colors.slate[500]};
  margin: 0 auto;
...
`,r2=m.div`
  ...
  &:hover {
    transform: translateY(${A.motion.iconLift}) scale(${A.motion.scaleHover});
  }
`,o2=m.div`
  aspect-ratio: 1 / 1;
  border-radius: ${({theme:n})=>n.radii["3xl"]};
...
`,u2=m.section`
  ...
  background: ${A.effects.carouselBackground};
  overflow: hidden;
`,f2=m.div`
  position: absolute;
  inset: 0;
  background: ${A.effects.carouselBackdrop};
`,d2=m.div`
  position: relative;
  width: ${A.layout.fullViewportWidth};
  left: 50%;
  transform: translateX(-50%);
  padding: ${A.sizing.carouselShellPadding};
...
`,p2=m(qu)`
  ...
  .slick-slide {
    padding: ${A.sizing.carouselSlidePadding};
  }
  ...
  .slick-slide .carousel-card {
    opacity: ${A.effects.carouselCardOpacity};
    transform: scale(${A.motion.scaleDown});
  ...
  .slick-center .carousel-card {
    opacity: 1;
    transform: scale(${A.motion.scaleActive});
    filter: ${A.effects.carouselDropShadow};
    pointer-events: auto;
  }
  ...
  @media (max-width: ${({theme:n})=>n.breakpoints.sm}) {
    ...
    .slick-slide {
      padding: ${A.sizing.carouselSlidePaddingSm};
    }
    ...
    .slick-slide .carousel-caption {
      opacity: 1;
      transform: scale(1);
      margin-top: ${A.sizing.carouselCaptionOffsetSm};
    }
...
`,g2=m.div`
  ...
  overflow: hidden;
  background: ${({theme:n})=>n.colors.slate[900]};
  box-shadow: ${A.effects.carouselCardShadow};
  cursor: pointer;
`,h2=m.img`
  width: 100%;
  height: 100%;
...
`,m2=m.p`
  ...
  color: ${A.effects.carouselCaptionMuted};
  letter-spacing: ${({theme:n})=>n.typography.letterSpacing.tight};
`,y2=m.button`
  width: ${({theme:n})=>n.spacing[8]};
  height: ${({theme:n})=>n.spacing[8]};
  border-radius: ${({theme:n})=>n.radii.full};
  border: ${A.sizing.hairline} solid ${A.effects.glassWhite20};
  background: ${A.effects.glassWhite10};
  color: ${({theme:n})=>n.colors.white};
  backdrop-filter: blur(${A.effects.blurGlass});
  cursor: pointer;
...
`;m.div`
  border-radius: ${({theme:n})=>n.radii["4xl"]};
  overflow: hidden;
  background: ${A.effects.compositionGradient};
  padding: ${({theme:n})=>n.spacing[8]};
  box-shadow: ${({theme:n})=>n.shadows.card};
...
`,$2=[`${Et}/images/brand/app-icons-splash-screens/icons/elemental-quest-alt.png`,`${Et}/images/brand/app-icons-splash-screens/icons/monstrous-evorise-icon.png`,`${Et}/images/brand/app-icons-splash-screens/icons/cat-wars.png`,`${Et}/images/brand/app-icons-splash-screens/icons/fatty-fish.png`,`${Et}/images/brand/app-icons-splash-screens/icons/feed-me.png`,`${Et}/images/brand/app-icons-splash-screens/icons/elemental-quest.png`,`${Et}/images/brand/app-icons-splash-screens/icons/revback.png`,`${Et}/images/brand/app-icons-splash-screens/icons/selara.png`,`${Et}/images/brand/app-icons-splash-screens/icons/sky-hero-icon.png`],w2=[`${Et}/images/brand/app-icons-splash-screens/splash-screens/cat-wars.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/elemental-craft.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/elemental-quest.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/fatty-fish.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/feed-me.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/monstrous-evorise.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/revback.png`,`${Et}/images/brand/app-icons-splash-screens/splash-screens/selara.png`],z2=({onBack:n})=>{const{t:o}=At(),u=Ae.useRef(null),s=()=>{if(n){n();return}window.location.hash="#work"},y=G=>{u.current&&u.current.slickGoTo(G)},b=Ae.useMemo(()=>new Date().getFullYear(),[]),M=Ae.useMemo(()=>({centerMode:!0,centerPadding:A.carousel.centerPaddingLg,infinite:!0,slidesToShow:A.carousel.slidesToShowLg,speed:A.carousel.speed,autoplay:!0,autoplaySpeed:A.carousel.autoplaySpeed,pauseOnHover:!0,arrows:!0,nextArrow:d.jsx(kh,{direction:"next",ariaLabel:o.appIcons.next}),prevArrow:d.jsx(kh,{direction:"prev",ariaLabel:o.appIcons.previous}),responsive:[{breakpoint:A.carousel.breakpointLg,settings:{slidesToShow:A.carousel.slidesToShowMd,centerPadding:A.carousel.centerPaddingMd}},{breakpoint:A.carousel.breakpointSm,settings:{slidesToShow:A.carousel.slidesToShowSm,slidesToScroll:A.carousel.slidesToScrollSm,centerPadding:A.carousel.centerPaddingSm,centerMode:!1,arrows:!1}},{breakpoint:A.carousel.breakpointXs,settings:{slidesToShow:A.carousel.slidesToShowSm,slidesToScroll:A.carousel.slidesToScrollSm,centerPadding:A.carousel.centerPaddingSm,centerMode:!1,arrows:!1}}]}),[o]);return d.jsxs(Px,{children:[d.jsx(Wx,{children:d.jsxs(Jx,{children:[d.jsxs(Ix,{onClick:s,"aria-label":o.appIcons.backToPortfolioAria,children:[d.jsx(mn,{size:18}),o.appIcons.backToPortfolio]}),d.jsx(Fx,{children:o.work.categories.brandDesign})]})}),d.jsx(e2,{children:d.jsxs(mu,{children:[d.jsx(t2,{children:o.appIcons.eyebrow}),d.jsxs(n2,{children:[o.appIcons.titlePrimary," ",d.jsx("em",{children:o.appIcons.titleEmphasis})]}),d.jsx(a2,{children:o.appIcons.lead})]})}),d.jsx(i2,{children:d.jsxs(mu,{children:[d.jsxs(Oh,{children:[d.jsx(_h,{}),d.jsx(Ah,{children:o.appIcons.appIconsTitle})]}),d.jsx(l2,{children:$2.map((G,k)=>d.jsxs(r2,{children:[d.jsx(o2,{children:d.jsx(s2,{src:G,alt:o.appIcons.iconLabels[k]})}),d.jsx(c2,{children:o.appIcons.iconLabels[k]})]},G))})]})}),d.jsxs(u2,{children:[d.jsx(f2,{}),d.jsx(mu,{style:{position:"relative",zIndex:1},children:d.jsxs(Oh,{children:[d.jsx(_h,{$light:!0}),d.jsx(Ah,{$light:!0,children:o.appIcons.splashScreensTitle})]})}),d.jsx(d2,{children:d.jsx(p2,{ref:u,...M,children:w2.map((G,k)=>d.jsxs("div",{onClick:()=>y(k),children:[d.jsx(g2,{className:"carousel-card",children:d.jsx(h2,{src:G,alt:o.appIcons.splashLabels[k],loading:"lazy"})}),d.jsx(m2,{className:"carousel-caption",children:o.appIcons.splashLabels[k]})]},G))})})]}),d.jsx(v2,{children:d.jsxs(b2,{children:[d.jsxs(S2,{children:["© ",b," ",Eo,". ",o.appIcons.footerRights]}),d.jsxs(x2,{onClick:s,children:[o.appIcons.viewMoreProjects,d.jsx(Uu,{size:16})]})]})})]})},T2=m.section`
  min-height: ${A.layout.fullViewportHeight};
  background: ${A.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,j2=m.header`
...
`,B2=m.img`
  ...
  object-fit: contain;
  display: block;
`,G2=n=>n.includes(" ")?encodeURI(n):n,q2=({onBack:n})=>{const{t:o}=At(),u=Oo.find(y=>y.id===17),s=Ae.useMemo(()=>{const y=(u==null?void 0:u.gallery)??[],b=[],M=new Map;return y.forEach(G=>{const le=decodeURIComponent(G.split("/").pop()??"").replace(/\.[^/.]+$/,"").replace(/^\d+\s+/,"").replace(/\s+\d+$/,"")||"Screenshots";M.has(le)?b[M.get(le)].items.push(G):(M.set(le,b.length),b.push({name:le,items:[G]}))}),b},[u==null?void 0:u.gallery]);return d.jsxs(T2,{children:[d.jsx(j2,{children:d.jsxs(E2,{children:[d.jsxs(O2,{onClick:n,children:[d.jsx(mn,{size:18}),o.appStoreScreenshots.backToPortfolio]}),d.jsx(_2,{children:o.appStoreScreenshots.headerTag})]})}),d.jsxs(k2,{children:[d.jsx(C2,{children:o.appStoreScreenshots.eyebrow}),d.jsx(M2,{children:o.appStoreScreenshots.title}),o.appStoreScreenshots.lead&&d.jsx(D2,{children:o.appStoreScreenshots.lead})]}),d.jsx(H2,{children:d.jsx(A2,{children:s.map(y=>d.jsxs(R2,{children:[d.jsx(L2,{children:y.name}),d.jsx(N2,{children:y.items.map((b,M)=>d.jsx(U2,{children:d.jsx(B2,{src:G2(b),alt:`${y.name} ${M+1}`,loading:"lazy"})},`${y.name}-${M}`))})]},y.name))})})]})},Y2=m.section`
  min-height: ${A.layout.fullViewportHeight};
  background: ${({theme:n})=>n.colors.white};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,V2=m.header`
...
`,e$=m.img`
  ...
  object-fit: contain;
  border-radius: ${({theme:n})=>n.radii["3xl"]};
`,t$=n=>n.includes(" ")?encodeURI(n):n,n$=({onBack:n})=>{const{t:o}=At();return d.jsxs(Y2,{children:[d.jsx(V2,{children:d.jsxs(X2,{children:[d.jsxs(Q2,{onClick:n,children:[d.jsx(mn,{size:18}),o.namelaka.backToPortfolio]}),d.jsx(Z2,{children:o.namelaka.headerTag})]})}),d.jsxs(P2,{children:[d.jsx(W2,{children:o.namelaka.eyebrow}),d.jsx(J2,{children:o.namelaka.title})]}),d.jsx(I2,{children:d.jsx(K2,{children:d.jsx(F2,{children:d.jsx(e$,{src:t$("/assets/images/brand/Namelaka icons and illustration/Namelaka.png"),alt:o.namelaka.title})})})})]})},Hm="/assets",a$=`${Hm}/video/Mindzy – Brain Training`,i$=`${Hm}/images/brand/Mindzy – Brain Training/UI/2_Full_Composition_Mindzy – Brain Training.png`,l$=m.section`
  min-height: ${A.layout.fullViewportHeight};
  background: ${A.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,Ch=m.div`
...
`,Mh=({className:n,style:o,onClick:u,direction:s,ariaLabel:y})=>d.jsx(T$,{className:n,style:o,onClick:u,"aria-label":y,children:s==="next"?d.jsx(Uu,{size:18}):d.jsx(mn,{size:18})}),Dh=n=>n.includes(" ")?encodeURI(n):n,j$=["Catch the bug.MP4","Color count.MP4","Linking Pairs.mov","Magnetic Grid.MP4","Match pairs.MP4","Missing operations.MP4","Numbers sum.MP4","Rain dots.MP4","Remember the bubbles.MP4","Robot Runner.MP4","Simon game.MP4","Space percentages.MP4","Spelling Correction.MP4","Sum Squares.MP4","Word Pairs.MP4"],E$=({onBack:n})=>{const{t:o}=At(),u=Ae.useRef(null),s=()=>{if(n){n();return}window.location.hash="#work"},y=G=>{u.current&&u.current.slickGoTo(G)},b=Ae.useMemo(()=>j$.map(G=>`${a$}/${G}`),[]),M=Ae.useMemo(()=>({centerMode:!0,centerPadding:"120px",infinite:!0,slidesToShow:3,speed:A.carousel.speed,autoplay:!0,autoplaySpeed:A.carousel.autoplaySpeed,pauseOnHover:!0,arrows:!0,nextArrow:d.jsx(Mh,{direction:"next",ariaLabel:o.appIcons.next}),prevArrow:d.jsx(Mh,{direction:"prev",ariaLabel:o.appIcons.previous}),responsive:[{breakpoint:A.carousel.breakpointLg,settings:{slidesToShow:3,centerPadding:"60px"}},{breakpoint:A.carousel.breakpointSm,settings:{slidesToShow:2,slidesToScroll:A.carousel.slidesToScrollSm,centerPadding:"20px",centerMode:!1,arrows:!1}},{breakpoint:A.carousel.breakpointXs,settings:{slidesToShow:1,slidesToScroll:A.carousel.slidesToScrollSm,centerPadding:A.carousel.centerPaddingSm,centerMode:!1,arrows:!1}}]}),[o]);return d.jsxs(l$,{children:[d.jsx(r$,{children:d.jsxs(o$,{children:[d.jsxs(s$,{onClick:s,children:[d.jsx(mn,{size:18}),o.mindzy.backToPortfolio]}),d.jsx(c$,{children:o.work.categories.uiuxDesign})]})}),d.jsx(u$,{$coverUrl:Dh(i$),children:d.jsx(Ch,{children:d.jsxs(f$,{children:[d.jsx(d$,{children:o.mindzy.eyebrow}),d.jsx(p$,{children:o.mindzy.title}),o.mindzy.lead&&d.jsx(g$,{children:o.mindzy.lead})]})})}),d.jsxs(v$,{children:[d.jsx(b$,{}),d.jsx(Ch,{children:d.jsxs(h$,{children:[d.jsx(m$,{}),d.jsx(y$,{children:o.mindzy.videoTitle})]})}),d.jsx(S$,{children:d.jsx(x$,{ref:u,...M,children:b.map((G,k)=>{var _;return d.jsxs("div",{onClick:()=>y(k),children:[d.jsx($$,{className:"carousel-card",children:d.jsx(w$,{src:Dh(G),muted:!0,loop:!0,playsInline:!0,autoPlay:!0,preload:"metadata"})}),d.jsx(z$,{className:"carousel-caption",children:(_=G.split("/").pop())==null?void 0:_.replace(/\.(MP4|mov)$/i,"")})]},G)})})})]})]})},Rm="/assets",Hh=`${Rm}/video/Marketing video`,O$=`${Rm}/images/brand/Full_Composition_Marketing_video.png`,_$=m.section`
  min-height: ${A.layout.fullViewportHeight};
  background: ${A.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,A$=m.div`
...
`,Sw=m.header`
  ...
  backdrop-filter: blur(${A.effects.blurStrong});
  border-bottom: ${A.sizing.hairline} solid rgba(255, 255, 255, 0.1);
`,xw=m.div`
  max-width: ${({theme:n})=>n.layout.container};
  margin: 0 auto;
  padding: ${({theme:n})=>n.spacing[4]} ${({theme:n})=>n.spacing[6]};
...
`,Mw=m.img`
  ...
  height: auto;
  display: block;
`,Nh=n=>n.includes(" ")?encodeURI(n):n,Dw=({onBack:n})=>{const{t:o}=At();return d.jsxs(bw,{children:[d.jsx(Sw,{children:d.jsxs(xw,{children:[d.jsxs($w,{onClick:n,children:[d.jsx(mn,{size:18}),o.combatPlanes.backToPortfolio]}),d.jsx(ww,{children:o.combatPlanes.headerTag})]})}),d.jsxs(zw,{children:[d.jsx(Tw,{children:o.combatPlanes.eyebrow}),d.jsx(jw,{children:o.combatPlanes.title}),d.jsx(Ew,{children:o.combatPlanes.lead})]}),d.jsxs(Ow,{children:[d.jsx(_w,{children:d.jsx(Aw,{src:Nh(yw),alt:o.combatPlanes.logoAlt})}),d.jsx(kw,{children:vw.map((u,s)=>d.jsx(Cw,{children:d.jsx(Mw,{src:Nh(u),alt:`${o.combatPlanes.galleryAlt} ${s+1}`})},s))})]})]})},Lm="/assets",Ql=`${Lm}/images/brand/Fatty Fish`,Hw=`${Ql}/Logo Fatty Fish.png`,Rw=`${Lm}/video/Fatty Fish/Fatty Fish video.mp4`,Lw=[`${Ql}/Character.png`,`${Ql}/Objects.png`],Nw=[`${Ql}/IMG_1.png`,`${Ql}/IMG_2.png`],Uw=m.section`
  min-height: ${A.layout.fullViewportHeight};
  background: #4F22D1;
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,Bw=m.header`
...
`,g5=n=>{Ae.useEffect(()=>{if(!n)return;const o=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=o}},[n])},h5=(n,o)=>{const u=document.getElementById(n);if(!u)return;const s=u.getBoundingClientRect().top+window.scrollY-o;window.scrollTo({top:s,behavior:"smooth"})},m5=m.div`
  min-height: ${A.layout.fullViewportHeight};
  background: ${Fe.bg};
  color: ${Fe.white};
  overflow-x: hidden;
...
`,lz=m.div`
  position: fixed;
  inset: 0;
  z-index: ${A.zIndex.background};
  pointer-events: none;
  overflow: hidden;
`,xu=m.div`
  position: absolute;
  border-radius: ${({theme:n})=>n.radii.full};
  filter: blur(${A.effects.blurBlob});
  opacity: ${A.effects.blobOpacity};
  ...
  ${({$position:n})=>n==="top-right"&&`
      ...
      width: 40%;
      height: 40%;
      background: ${A.effects.blobPurple};
      animation: none;
    `}
...
`,oz=m.div`
  ...
  z-index: ${A.zIndex.nav};
  display: flex;
  flex-direction: column;
  gap: ${({theme:n})=>n.spacing[1]};
  padding: ${({theme:n})=>n.spacing[2]};
  border-radius: ${({theme:n})=>n.radii.full};
  background: ${A.effects.glassWhite80};
  backdrop-filter: blur(${A.effects.blurGlass});
  box-shadow: ${({theme:n})=>n.shadows.md};
  border: ${A.sizing.hairline} solid ${({theme:n})=>n.colors.slate[100]};
`,Kh=m.button`
