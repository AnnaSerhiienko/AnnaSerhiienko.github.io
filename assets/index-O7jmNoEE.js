...
`,fg=({className:n,style:o,onClick:f,direction:u,ariaLabel:g})=>m.jsx(Yx,{className:n,style:o,onClick:f,"aria-label":g,children:u==="next"?m.jsx(zc,{size:18}):m.jsx(Ra,{size:18})}),Xx=w.section`
  padding: ${({theme:n})=>n.spacing[12]} ${({theme:n})=>n.spacing[6]};
`,Vx=w.div`
  border-radius: ${({theme:n})=>n.radii["4xl"]};
  overflow: hidden;
...
`,g2=w.img`
  ...
  object-fit: contain;
  display: block;
`,m2=n=>n.includes(" ")?encodeURI(n):n,y2=({onBack:n})=>{const{t:o}=nn(),f=po.find(g=>g.id===17),u=qe.useMemo(()=>{const g=(f==null?void 0:f.gallery)??[],y=[],C=new Map;return g.forEach(Q=>{const ne=decodeURIComponent(Q.split("/").pop()??"").replace(/\.[^/.]+$/,"").replace(/^\d+\s+/,"").replace(/\s+\d+$/,"")||"Screenshots";C.has(ne)?y[C.get(ne)].items.push(Q):(C.set(ne,y.length),y.push({name:ne,items:[Q]}))}),y},[f==null?void 0:f.gallery]);return m.jsxs(e2,{children:[m.jsx(t2,{children:m.jsxs(n2,{children:[m.jsxs(a2,{onClick:n,children:[m.jsx(Ra,{size:18}),o.appStoreScreenshots.backToPortfolio]}),m.jsx(i2,{children:o.appStoreScreenshots.headerTag})]})}),m.jsxs(r2,{children:[m.jsx(o2,{children:o.appStoreScreenshots.eyebrow}),m.jsx(s2,{children:o.appStoreScreenshots.title}),o.appStoreScreenshots.lead&&m.jsx(u2,{children:o.appStoreScreenshots.lead})]}),m.jsx(c2,{children:m.jsx(l2,{children:u.map(g=>m.jsxs(f2,{children:[m.jsx(d2,{children:g.name}),m.jsx(p2,{children:g.items.map((y,C)=>m.jsx(h2,{children:m.jsx(g2,{src:m2(y),alt:`${g.name} ${C+1}`,loading:"lazy"})},`${g.name}-${C}`))})]},g.name))})})]})},v2=w.section`
  min-height: ${j.layout.fullViewportHeight};
  background: ${({theme:n})=>n.colors.white};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,b2=w.header`
...
`,_2=w.img`
  ...
  object-fit: contain;
  border-radius: ${({theme:n})=>n.radii["3xl"]};
`,j2=n=>n.includes(" ")?encodeURI(n):n,M2=({onBack:n})=>{const{t:o}=nn();return m.jsxs(v2,{children:[m.jsx(b2,{children:m.jsxs(S2,{children:[m.jsxs(x2,{onClick:n,children:[m.jsx(Ra,{size:18}),o.namelaca.backToPortfolio]}),m.jsx(w2,{children:o.namelaca.headerTag})]})}),m.jsxs(z2,{children:[m.jsx(O2,{children:o.namelaca.eyebrow}),m.jsx(T2,{children:o.namelaca.title})]}),m.jsx(A2,{children:m.jsx($2,{children:m.jsx(E2,{children:m.jsx(_2,{src:j2("/assets/images/brand/Namelaca icons and illustration/Namelaca.png"),alt:o.namelaca.title})})})})]})},lm="/assets",C2=`${lm}/video/Mindzy – Brain Training`,k2=`${lm}/images/brand/Mindzy – Brain Training/UI/2_Full_Composition_Mindzy – Brain Training.png`,D2=w.section`
  min-height: ${j.layout.fullViewportHeight};
  background: ${j.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,dg=w.div`
...
`,pg=({className:n,style:o,onClick:f,direction:u,ariaLabel:g})=>m.jsx(ew,{className:n,style:o,onClick:f,"aria-label":g,children:u==="next"?m.jsx(zc,{size:18}):m.jsx(Ra,{size:18})}),hg=n=>n.includes(" ")?encodeURI(n):n,tw=["Air Traffic.MP4","Catch the bug.MP4","Color count.MP4","Linking Pairs.MP4","Magnetic Grid.MP4","Match pairs.MP4","Missing operations.MP4","Numbers sum.MP4","Rain dots.MP4","Remember the bubbles.MP4","Robot Runner.MP4","Simon game.MP4","Space percentages.MP4","Spelling Correction.MP4","Sum Squares.MP4","Word Pairs.MP4"],nw=({onBack:n})=>{const{t:o}=nn(),f=()=>{if(n){n();return}window.location.hash="#work"},u=qe.useMemo(()=>tw.map(y=>`${C2}/${y}`),[]),g=qe.useMemo(()=>({centerMode:!0,centerPadding:"120px",infinite:!0,slidesToShow:3,speed:j.carousel.speed,autoplay:!0,autoplaySpeed:j.carousel.autoplaySpeed,pauseOnHover:!0,arrows:!0,nextArrow:m.jsx(pg,{direction:"next",ariaLabel:o.appIcons.next}),prevArrow:m.jsx(pg,{direction:"prev",ariaLabel:o.appIcons.previous}),responsive:[{breakpoint:j.carousel.breakpointLg,settings:{slidesToShow:3,centerPadding:"60px"}},{breakpoint:j.carousel.breakpointSm,settings:{slidesToShow:2,slidesToScroll:j.carousel.slidesToScrollSm,centerPadding:"20px",centerMode:!1,arrows:!1}},{breakpoint:j.carousel.breakpointXs,settings:{slidesToShow:1,slidesToScroll:j.carousel.slidesToScrollSm,centerPadding:j.carousel.centerPaddingSm,centerMode:!1,arrows:!1}}]}),[o]);return m.jsxs(D2,{children:[m.jsx(R2,{children:m.jsxs(H2,{children:[m.jsxs(N2,{onClick:f,children:[m.jsx(Ra,{size:18}),o.mindzy.backToPortfolio]}),m.jsx(U2,{children:o.work.categories.uiuxDesign})]})}),m.jsx(L2,{$coverUrl:hg(k2),children:m.jsx(dg,{children:m.jsxs(B2,{children:[m.jsx(q2,{children:o.mindzy.eyebrow}),m.jsx(G2,{children:o.mindzy.title}),o.mindzy.lead&&m.jsx(Y2,{children:o.mindzy.lead})]})})}),m.jsxs(Z2,{children:[m.jsx(K2,{}),m.jsx(dg,{children:m.jsxs(X2,{children:[m.jsx(V2,{}),m.jsx(Q2,{children:o.mindzy.videoTitle})]})}),m.jsx(J2,{children:m.jsx(W2,{...g,children:u.map(y=>{var C;return m.jsxs("div",{children:[m.jsx(I2,{className:"carousel-card",children:m.jsx(P2,{src:hg(y),muted:!0,loop:!0,playsInline:!0,autoPlay:!0})}),m.jsx(F2,{className:"carousel-caption",children:(C=y.split("/").pop())==null?void 0:C.replace(".MP4","")})]},y)})})})]})]})},rm="/assets",gg=`${rm}/video/Marketing video`,aw=`${rm}/images/brand/Full_Composition_Marketing_video.png`,iw=w.section`
  min-height: ${j.layout.fullViewportHeight};
  background: ${j.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,lw=w.div`
...
`;w.video`
  ...
  height: 100%;
  object-fit: cover;
`;const ic=n=>encodeURI(n),$w=["1080x1920.mp4","App Store.mp4","Concept_2_1080x1920.mp4","video5_1080x1920.mp4","Video_1080x1920_android.mp4","valentine_stickers.mp4"],zw=["Comp 1.mp4","Concept 1 17-09_1.mp4","main video_2.mp4","video.mp4","Google play.mp4","Video (1).mp4"],Ow=({onBack:n})=>{const{t:o}=nn(),f=()=>{if(n){n();return}window.location.hash="#work"};return m.jsxs(iw,{children:[m.jsx(rw,{children:m.jsxs(ow,{children:[m.jsxs(sw,{onClick:f,children:[m.jsx(Ra,{size:18}),o.marketingVideo.backToPortfolio]}),m.jsx(uw,{children:o.marketingVideo.headerTag})]})}),m.jsxs(cw,{style:{"--hero-cover-url":`url(${ic(aw)})`},children:[m.jsx(fw,{}),m.jsxs(dw,{children:[m.jsx(pw,{children:o.marketingVideo.eyebrow}),m.jsx(hw,{children:o.marketingVideo.title}),m.jsx(gw,{children:o.marketingVideo.lead})]})]}),m.jsxs(lw,{children:[m.jsxs(mw,{children:[m.jsx(yw,{}),m.jsx(vw,{children:o.marketingVideo.allVideosTitle})]}),m.jsx(bw,{children:$w.map(u=>m.jsx(ww,{children:m.jsx(mg,{src:ic(`${gg}/${u}`),muted:!0,loop:!0,playsInline:!0,autoPlay:!0})},u))}),m.jsx(Sw,{children:zw.map(u=>m.jsx(xw,{children:m.jsx(mg,{src:ic(`${gg}/${u}`),muted:!0,loop:!0,playsInline:!0,autoPlay:!0})},u))})]})]})},Tw=w.div.attrs(({$width:n})=>({style:{width:`${n}%`}}))`
  position: fixed;
  top: 0;
  left: 0;
...
`,Aw=()=>{const[n,o]=qe.useState(0);return qe.useEffect(()=>{const f=()=>{const u=document.body.scrollTop||document.documentElement.scrollTop,g=document.documentElement.scrollHeight-document.documentElement.clientHeight,y=g>0?u/g*100:0;o(y)};return f(),window.addEventListener("scroll",f,{passive:!0}),()=>window.removeEventListener("scroll",f)},[]),m.jsx(Tw,{$width:n})},Ew=Mi`
  0%, 100% { opacity: 0.6; }
  50% { opacity: 1; }
`,_w=w.div`
  min-height: ${j.layout.fullViewportHeight};
...
`,lc=w.div`
  ...
  animation: ${Ew} 3s ease-in-out infinite;
...
`,kw=()=>{const{lang:n,setLang:o,t:f}=nn();return m.jsxs(Cw,{children:[m.jsx(yg,{$active:n==="en",onClick:()=>o("en"),title:f.languageSwitch.enTitle,children:f.languageSwitch.enShort}),m.jsx(yg,{$active:n==="uk",onClick:()=>o("uk"),title:f.languageSwitch.ukTitle,children:f.languageSwitch.ukShort})]})};function Dw(){const[n,o]=qe.useState(Pe.PORTFOLIO),[f,u]=qe.useState(en.HERO),g="app-icons",y="app-store-screenshots",C="namelaca",Q="mindzy",G="marketing-video";qe.useEffect(()=>{const Y=()=>{if(!window.location.hash)return;const ne=window.location.hash.replace("#","");if(ne===g){o(Pe.APP_ICONS);return}if(ne===y){o(Pe.APP_STORE_SCREENSHOTS);return}if(ne===C){o(Pe.NAMELACA);return}if(ne===Q){o(Pe.MINDZY);return}if(ne===G){o(Pe.MARKETING_VIDEO);return}const ue=ne,le=document.getElementById(ue);le&&(o(Pe.PORTFOLIO),u(ue),le.scrollIntoView({behavior:"smooth",block:"start"}))};return Y(),window.addEventListener("hashchange",Y),()=>window.removeEventListener("hashchange",Y)},[]),qe.useEffect(()=>{if(n!==Pe.PORTFOLIO)return;const Y=document.getElementById(f);Y&&Y.scrollIntoView({behavior:"smooth",block:"start"})},[n,f]),qe.useEffect(()=>{(n===Pe.APP_ICONS||n===Pe.APP_STORE_SCREENSHOTS||n===Pe.NAMELACA||n===Pe.MINDZY||n===Pe.MARKETING_VIDEO)&&window.scrollTo({top:0,behavior:"smooth"})},[n]);const $=Y=>{o(Pe.PORTFOLIO),u(Y),window.history.pushState(null,"",`#${Y}`);const ne=document.getElementById(Y);ne&&ne.scrollIntoView({behavior:"smooth",block:"start"})},X=()=>{o(Pe.PORTFOLIO),u(en.WORK),window.history.pushState(null,"",`#${en.WORK}`);const Y=document.getElementById(en.WORK);Y&&Y.scrollIntoView({behavior:"smooth",block:"start"})};return m.jsxs(_w,{children:[m.jsxs(jw,{children:[m.jsx(lc,{$position:"top-left"}),m.jsx(lc,{$position:"top-right"}),m.jsx(lc,{$position:"bottom-left"})]}),m.jsxs(Mw,{children:[m.jsx(Aw,{}),n===Pe.PORTFOLIO&&m.jsxs(m.Fragment,{children:[m.jsx(kw,{}),m.jsx(Qb,{onNavigate:$})]}),n===Pe.PORTFOLIO?m.jsxs(m.Fragment,{children:[m.jsxs("main",{children:[m.jsx(s1,{}),m.jsx(uS,{}),m.jsx(RS,{})]}),m.jsx(YS,{})]}):n===Pe.APP_ICONS?m.jsx(Fx,{onBack:X}):n===Pe.APP_STORE_SCREENSHOTS?m.jsx(y2,{onBack:X}):n===Pe.NAMELACA?m.jsx(M2,{onBack:X}):n===Pe.MINDZY?m.jsx(nw,{onBack:X}):n===Pe.MARKETING_VIDEO?m.jsx(Ow,{onBack:X}):null]})]})}function Rw(){return m.jsx(_b,{children:m.jsx(Dw,{})})}const Hw=Bv`
  *, *::before, *::after {
...
`,Nw={white:"#ffffff",black:"#000000",brand:{purple:"#6366f1",blue:"#3b82f6",pink:"#ec4899"},slate:{50:"#f8fafc",100:"#f1f5f9",200:"#e2e8f0",300:"#cbd5e1",400:"#94a3b8",500:"#64748b",600:"#475569",700:"#334155",800:"#1e293b",900:"#0f172a"}},Uw={0:"0px",1:"4px",2:"8px",3:"12px",4:"16px",5:"20px",6:"24px",7:"32px",8:"40px",9:"48px",10:"56px",11:"64px",12:"72px",13:"80px",14:"96px",15:"112px",16:"128px"},Lw={none:"0px",sm:"8px",md:"12px",lg:"16px",xl:"20px","2xl":"24px","3xl":"32px","4xl":"48px",full:"9999px"},Bw={sm:"0 1px 2px rgba(15, 23, 42, 0.08)",md:"0 6px 20px rgba(15, 23, 42, 0.12)",lg:"0 16px 40px rgba(15, 23, 42, 0.14)",xl:"0 24px 60px rgba(15, 23, 42, 0.18)",card:"0 24px 60px rgba(15, 23, 42, 0.08)"},qw={fonts:{sans:"'Inter', sans-serif",serif:"'Inter', sans-serif"},weights:{light:300,regular:400,medium:500,semibold:600,bold:700},sizes:{xs:"0.64rem",sm:"0.8rem",md:"1rem",lg:"1.25rem",xl:"1.5625rem","2xl":"1.9531rem","3xl":"2.4413rem","4xl":"3.0519rem","5xl":"3.8147rem","6xl":"4.7684rem","7xl":"5.9605rem"},lineHeights:{tight:1.1,snug:1.25,normal:1.5,relaxed:1.7},letterSpacing:{tight:"-0.02em",normal:"0em",wide:"0.2em",wider:"0.3em"}},Gw={container:"1280px"},Yw={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px"},Xw={colors:Nw,spacing:Uw,radii:Lw,shadows:Bw,typography:qw,layout:Gw,breakpoints:Yw},om=document.getElementById("root");if(!om)throw new Error("Could not find root element to mount to");const Vw=U0.createRoot(om);Vw.render(m.jsx(pt.StrictMode,{children:m.jsxs(Nv,{theme:Xw,children:[m.jsx(Hw,{}),m.jsx(Rw,{})]})}));
