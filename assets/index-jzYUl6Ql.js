...
`,E$=y.img`
  ...
  object-fit: contain;
  border-radius: ${({theme:n})=>n.radii["3xl"]};
`,_$=n=>n.includes(" ")?encodeURI(n):n,j$=({onBack:n})=>{const{t:o}=At();return h.jsxs(y$,{children:[h.jsx(v$,{children:h.jsxs(b$,{children:[h.jsxs(S$,{onClick:n,children:[h.jsx(yn,{size:18}),o.namelaca.backToPortfolio]}),h.jsx(x$,{children:o.namelaca.headerTag})]})}),h.jsxs(w$,{children:[h.jsx(z$,{children:o.namelaca.eyebrow}),h.jsx(T$,{children:o.namelaca.title})]}),h.jsx(O$,{children:h.jsx($$,{children:h.jsx(A$,{children:h.jsx(E$,{src:_$("/assets/images/brand/Namelaca icons and illustration/Namelaca.png"),alt:o.namelaca.title})})})})]})},fm="/assets",M$=`${fm}/video/Mindzy – Brain Training`,C$=`${fm}/images/brand/Mindzy – Brain Training/UI/2_Full_Composition_Mindzy – Brain Training.png`,k$=y.section`
  min-height: ${E.layout.fullViewportHeight};
  background: ${E.effects.appIconsBackground};
  padding-bottom: ${({theme:n})=>n.spacing[16]};
`,mh=y.div`
